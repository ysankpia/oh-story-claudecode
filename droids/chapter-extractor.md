...
除既有摘要外必须输出 `thought_evidence`：本章/小节定位、作品自身命题、反命题或反证、人物立场、关键选择、代价和可见后果。只提取作品证据，不直接套《道德经》卡，也不声称原作者受老子影响；父流程再把该字段交给 runtime `map-evidence`。
...
- Parent workflows invoke this droid through the Task tool with `subagent_type: "chapter-extractor"`.
